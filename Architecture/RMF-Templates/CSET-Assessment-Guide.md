...
| Identity management | MFA for remote access | Yes | `WatchGuard-IKEv2-VPN-Guide.md` (on-prem); `Deploy-VPNClient.ps1`; `Architecture/Azure-VPN-Guide.md` (cloud/federal target) |
