...
<#
.SYNOPSIS
    Phase 8.4.2 - Audits existing service accounts and converts standard user-based service identities to Group Managed Service Accounts (gMSA) where possible.

.DESCRIPTION
    Audits existing service accounts and converts standard user-based service identities to Group Managed Service Accounts (gMSA) where possible.
...
.NOTES
    ...
    Run on     : Lab-DC01
    Depends on : KDS root key
    NIST       : IA-5, IA-5(2), AC-2
...
Write-Host '  |  Phase 8.4.2 - Set ServiceAccountHardening' -ForegroundColor DarkCyan
Write-Host '  +======================================================+' -ForegroundColor DarkCyan
Write-Host ''

Write-Step "Scaffold script - not yet a turnkey implementation."
Write-Info  "Sub-phase  : 8.4.2 (Workload / NPI (optional))"
Write-Info  "Run on     : Lab-DC01"
Write-Info  "Depends on : KDS root key"
Write-Info  "NIST       : IA-5, IA-5(2), AC-2"
Write-Host ""
