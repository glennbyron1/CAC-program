...
Four-dimension federal upgrade path document covering the gap between the commercial baseline (GIDS / HIRSCH uTrust tokens, software KSP, internal two-tier PKI, admin-desk enrollment) and full FISMA/FedRAMP compliance (GSA APL tokens, FIPS 140-3 Level 3 HSM, FBCA cross-certification, SP 800-157 derived credential kiosk enrollment).
